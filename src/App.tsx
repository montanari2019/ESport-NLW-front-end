    ...
    <div className='max-w-[1344px] mx-auto flex flex-col items-center my-20' >
      ...
      <div className=' self-stretch mt-8 rounded-lg overflow-hidden pt-1 bg-nlw-gradient'>
        <div className='bg-[#2A2634] px-8 py-6 flex justify-between items-center'>
          ...
          <button type='button' className='hover:bg-violet-600 py-3 px-4 bg-violet-500 text-white rounded flex items-center gap-3'> <MagnifyingGlassPlus size={20} /> Publicar anuncio</button>
